...
hook.Add("ShouldCollide", "Prop.Collision", function(player, object)
	...
	if player:IsValid() and object:IsValid() then
		...
		if string.match(player:GetClass(), "prop_physics*") or string.match(entity:GetClass(), "prop_door*") or string.match(entity:GetClass(), "func_physbox*") and string.match(object:GetClass(), "prop_arsenalcrate*") then
			return false
		end
		--If the prop is a prop_physics and its colliding with an resupply box set collision to none.
		if string.match(player:GetClass(), "prop_physics*") or string.match(entity:GetClass(), "prop_door*") or string.match(entity:GetClass(), "func_physbox*") and string.match(object:GetClass(), "prop_resupplybox*") then
			return false
		end
		--If the prop is a prop_physics and its colliding with an message beacon set collision to none.
		if string.match(player:GetClass(), "prop_physics*") or string.match(entity:GetClass(), "prop_door*") or string.match(entity:GetClass(), "func_physbox*") and string.match(object:GetClass(), "prop_messagebeacon*") then
			return false
		end
		--If the prop is a prop_physics and its colliding with an gun turret set collision to none.
		if string.match(player:GetClass(), "prop_physics*") or string.match(entity:GetClass(), "prop_door*") or string.match(entity:GetClass(), "func_physbox*") and string.match(object:GetClass(), "prop_gunturret*") then
			return false
		end
		--If the prop is a prop_physics and its colliding with an detonation pack set collision to none.
		if string.match(player:GetClass(), "prop_physics*") or string.match(entity:GetClass(), "prop_door*") or string.match(entity:GetClass(), "func_physbox*") and string.match(object:GetClass(), "prop_detpack*") then
			return false
		end
		--If the prop is a prop_physics and its colliding with an spot lamp set collision to none.
		if string.match(player:GetClass(), "prop_physics*") or string.match(entity:GetClass(), "prop_door*") or string.match(entity:GetClass(), "func_physbox*") and string.match(object:GetClass(), "prop_spotlamp*") then
			return false
		end
	end
	end
